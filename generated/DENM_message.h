...
typedef struct {
  ...
  uint32_t v2x_header_StationID;                                                            /* Identifier_of_the_vehicle_(from_RFID_or_other_identification) */
  ...
  int32_t  v2x_denm_alacarte_LanePosition;                                                  /* lateral_position_in_the_lane_in_centimeters_(augmenting_position_purposes) */
  uint32_t v2x_denm_alacarte_RoadWorksContainerExtended_closedLanes_DrivingLaneStatus;      /* BIT_STRING_{_outermostLaneClosed(1),_secondLaneFromOutsideClosed(2)_}_(SIZE_(1..14))_A_lane_is_counted_from_outside_boarder_of_the_road._The_numbering_is_matched_to_LanePosition_DE_as_defined_in_clause_A.40._If_a_lane_is_closed_to_traffic,_the_corresponding_bit_shall_be_set_to_1._Otherwise,_it_shall_be_set_to_0. */
} DENM_message;
